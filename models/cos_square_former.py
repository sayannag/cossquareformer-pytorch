...
class cosSquareFormer(nn.Module):
    """O(n * d^2) Bi-directional Transformer that approximates softmax with kernels.

    If 'kernel' == 'relu' and 'use_cos' == True, the model from
    'Deciphering Environmental Air Pollution with Large Scale City Data' (https://arxiv.org/pdf/2109.04572.pdf)
    ...
    Attributes:
      use_cos: (bool) If True, the cos reweighting mechanism from 
        'Deciphering Environmental Air Pollution with Large Scale City Data' (https://arxiv.org/pdf/2109.04572.pdf) is implemented and positional
    ...
    def __init__(self, use_cos, kernel, d_model, n_heads, n_layers,
        ...
        """Initializes a cosSquareFormer Module.

        Args:
          use_cos: (bool) If True, the cosine-square reweighting mechanism from 
            'Deciphering Environmental Air Pollution with Large Scale City Data' (https://arxiv.org/pdf/2109.04572.pdf) is implemented and positional
            embeddings are not used. If False, sinusoidal positional embeddings are used.
        ...
        """
        super(cosSquareFormer, self).__init__()
    ...
    def get_cos_weights(self, lengths, max_len=None):
        ...
        Used for reweighting as described in 'Deciphering Environmental Air Pollution with Large Scale City Data' (https://arxiv.org/pdf/2109.04572.pdf).
        ...
        M = lengths
        # M -> [batch_size]
        idxs = math.pi * torch.arange(max_len).to(lengths)
        # idxs -> [max_len]
